...
public class UserController {
    ...
    public Page<UserDto> lista(@RequestParam(required = false) String userName,
                               @RequestParam int page, @RequestParam int amount, @RequestParam String ordination) {
        Pageable pageable = PageRequest.of(page, amount, Sort.Direction.DESC, ordination);
    ...
    public ResponseEntity<UserDto> register(@RequestBody @Valid UserForm form, UriComponentsBuilder uriBuilder) {
        User user = form.conveter(userRepository);
